...
(function () {
  ...
  var I18N = {
    ko: {
      ...
      'mag.plannedLead': '5주부터는 구성이 끝나는 대로 차례로 공개합니다. 아래에 이 주에 담을 내용을 미리 정리해 두었습니다.',
      'mag.planKicker': '52 WEEKS',
      'mag.planTitle': '1년 52주 플랜',
      'mag.planLead': '4분기 52주입니다. 발행된 주는 바로 읽을 수 있고, 아직 준비 중인 주는 계획을 먼저 보여 줍니다. 구성을 마치는 대로 차례대로 공개합니다.',
      'mag.planCardTitle': '이 주는 이렇게 구성됩니다',
      'mag.planGoals': '학습목표',
      'mag.planGrammar': '핵심 문법',
      'mag.planWords': '핵심 어휘',
      'mag.planPron': '발음 포인트',
      'mag.planOutput': '산출 과제',
      'mag.planParts': '구성 예정 섹션',
    ...
    en: {
      ...
      'mag.plannedLead': 'Weeks five onwards appear as soon as each one is finished. The plan below sets out what this week will hold.',
      'mag.planKicker': '52 WEEKS',
      'mag.planTitle': 'A 52-week plan',
      'mag.planLead': 'Fifty-two weeks across four quarters. Published weeks are ready to read; weeks still being written show their plan first.',
      'mag.planCardTitle': 'What this week will cover',
      'mag.planGoals': 'Learning goals',
      'mag.planGrammar': 'Grammar focus',
      'mag.planWords': 'Vocabulary focus',
      'mag.planPron': 'Pronunciation point',
      'mag.planOutput': 'Output task',
      'mag.planParts': 'Planned sections',
